...
import net.majorkernelpanic.SlackUtils;
...
public class SpydroidActivity extends FragmentActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		MenuItemCompat.setShowAsAction(menu.findItem(R.id.quit), MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
		MenuItemCompat.setShowAsAction(menu.findItem(R.id.options), MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
		return true;
	}
	...
	public void switchCamera(View view) {
		Session s = SlackUtils.INSTANCE.mSession;
		if(s != null){
			s.switchCamera();
		}
	}
